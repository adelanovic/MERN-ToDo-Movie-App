//Displays Popular Movies page /popular
...
export default class Popular extends Component {
    ...
    componentDidMount() {
        this.popularMovies().then(r => console.log("Loading Popular Movies"));
    ...
    async popularMovies() {
        const response = await axios.get(
            "https://api.themoviedb.org/3/movie/popular?api_key=a591ff1a7bf1324894e2c720c1fe0f2c&language=en-US&page=1")
    ...
    render() {
        return(
                ...
                <div className="container">
                    <h2 className="bg-success tableHeader" style={{marginTop: 20, fontWeight: "bold" }}>Popular Movies</h2>
