...
export default class Top extends Component {
    ...
    componentDidMount() {
        this.topMovies().then(r => console.log("Loading Top Movies"));
    ...
    async topMovies() {
        const response = await axios.get(
            "https://api.themoviedb.org/3/movie/top_rated?api_key=a591ff1a7bf1324894e2c720c1fe0f2c&language=en-US&page=1")
    ...
    render() {
        return(
            ...
            <div className="container">
                <h2 className="bg-success tableHeader" style={{marginTop: 20, fontWeight: "bold" }}>Top Movies</h2>
